...
namespace Fakir.Web
{
    public static class FrontEndBundleConfig
    {
        ...
        private static void AddFrontendCssLibs(BundleCollection bundles, bool isRTL = false)
        {
            bundles.Add(
        ...
        private static void AddFrontendCssMetronic(BundleCollection bundles, bool isRTL = false)
        {
            bundles.Add(
