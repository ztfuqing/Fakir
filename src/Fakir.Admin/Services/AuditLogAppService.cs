...
using Fakir.Admin.Services.Exporting;
...
{
    [DisableAuditing]
    [AbpAuthorize(AdminPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : FakirAppServiceBase, IAuditLogAppService
    {
